...
# ---------------------------------------
# CREATE JP_RESULTS FOLDER
# ---------------------------------------
folder_path = "JP_RESULTS"
os.makedirs(folder_path, exist_ok=True)

# ---------------------------------------
# LOAD JAPAN GDP
# ---------------------------------------
df = pd.read_csv("jp_gdp.csv")
...
# ---------------------------------------
# CRISIS DUMMY (Japan 1997, 1998, 2008)
# ---------------------------------------
df["year"] = df["date"].dt.year
df["crisis"] = 0

crisis_years = [1997, 1998, 2008]
df.loc[df["year"].isin(crisis_years), "crisis"] = 1
...
# SAVE DATASET
# ---------------------------------------
model_df.to_csv(os.path.join(folder_path, "jp_entropy_full_dataset.csv"), index=False)

print("JP_RESULTS folder fully saved.")
