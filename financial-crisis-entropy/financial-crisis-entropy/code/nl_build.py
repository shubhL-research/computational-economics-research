...
print("NETHERLANDS RESULTS")
print("Entropy coefficient:", model.coef_[0][0])
print("Volatility coefficient:", model.coef_[0][1])

# ---------- 10. SAVE ----------
os.makedirs("NL_RESULTS", exist_ok=True)
df.to_csv("NL_RESULTS/nl_entropy_full_dataset.csv", index=False)

print("NL_RESULTS folder fully saved.")