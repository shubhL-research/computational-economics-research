...
# ---------------------------------------
# CREATE CA_RESULTS FOLDER
# ---------------------------------------
folder_path = "CA_RESULTS"
os.makedirs(folder_path, exist_ok=True)

# ---------------------------------------
# LOAD CANADA GDP
# ---------------------------------------
df = pd.read_csv("ca_gdp.csv")
...
# SAVE DATASET
# ---------------------------------------
model_df.to_csv(os.path.join(folder_path, "ca_entropy_full_dataset.csv"), index=False)

print("CA_RESULTS folder fully saved.")
